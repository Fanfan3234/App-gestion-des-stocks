  ...
  if(isset($_GET['id'])) {
    ...
    if($client->voirutilisateur($_GET['id'])) {
      if($client->supputilisateur($_GET['id'])){
        Viewutilisateur::alert("success", "Utilisateur supprimé avec succès", "liste-utilisateursadmin.php");
      }
      else{
        Viewutilisateur::alert("danger", "Echec de la suppression", "liste-utilisateursadmin.php");
      }
    }
    else {
      Viewutilisateur::alert("danger", "utilisateur n'existe pas", "liste-utilisateursadmin.php");
    }
  }
  else {
